...
// Bluesky-style launch splash for ssbski: the brand logo on the brand-blue
// field, painted before the JS bundle runs and faded out once the app shell
...
const SSBSKI_SPLASH_STYLE =
  ...
  '#ssbski-splash{position:fixed;inset:0;z-index:9999;display:flex;' +
  'align-items:center;justify-content:center;background:#1085fe;' +
  'transition:opacity .45s ease;}' +
  '#ssbski-splash.is-hidden{opacity:0;pointer-events:none;}' +
  '#ssbski-splash img{width:92px;height:92px;border-radius:22px;' +
  'box-shadow:0 10px 34px rgba(0,0,0,.28);' +
  'animation:ssbski-splash-pop .6s ease both;}' +
  '@keyframes ssbski-splash-pop{0%{transform:scale(.82);opacity:0}' +
