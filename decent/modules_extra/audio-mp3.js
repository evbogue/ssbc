...
exports.create = function (api) {
  ...
  exports.message_content_mini = function (msg) {
    ...
    var v = msg.value.content
    var title = v.Title || v.Name || 'audio'
    var track = v.Track ? '(' + v.Track + ') ' : ''
    var link = v.link && api.blob_url ? h('a', {href: api.blob_url(v.link)}, 'play') : null
    return ['audio ', track, title, link ? [' ', link] : null]
  }
