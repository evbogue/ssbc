...
The frontend is a browser-based SSB client served from a single shared JavaScript bundle
(see the HTTP serving layer above).
...
- shared runtime skin selection in `decent/src/skin.js`
