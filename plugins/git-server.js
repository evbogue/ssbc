...
module.exports = {
  ...
  init(sbot, config) {
    // Later UI plugin initialization exposes its API on this shared config
    // object. Capture the listener settings now so that does not change URLs
    // returned by an already-initialized git plugin.
